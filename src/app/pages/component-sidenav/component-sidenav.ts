...
import {ActivatedRoute, Params, Route, RouterModule, Routes, UrlSegment, UrlSegmentGroup} from '@angular/router';
...
const routes: Routes = [ {
  ...
  children : [
    ...
    {
      matcher: utilitiesRouteMatcher,
      // path: 'utilities',
      component : UtilitiesViewerComponent,
      children: UTILITIES_ROUTES
    },
    {
      path : ':id',
      component : ComponentViewer,
      // canActivate: [CanActivateComponentViewer],
      children : [
