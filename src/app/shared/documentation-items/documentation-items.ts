...
const _SECTIONS: { [key: string]: DocSection } = {
  [COMPONENTS]: {
    name: 'Components',
  ...
  [UTILITIES]: {
    name: 'Utilities',
    summary: 'The Utilities is set a of tools for daily life'
  }
};

if (environment.production) {
  delete _SECTIONS[COMPONENTS];
  delete _SECTIONS[CDK];
}
